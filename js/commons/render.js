...
export function menuTreeControlsTemplate() {
  ...
  wrapper.innerHTML = `
    <div class="tree-controls d-flex align-items-center gap-2" id="tree-controls">
      ...
      <button class="btn btn-sm btn-light" id="tree-toggle" title="Apri/Chiudi tutti"><i class="fas fa-chevron-down"></i></button>
  ...
  return {
    ...
    toggleAll: wrapper.querySelector('#tree-toggle'),
